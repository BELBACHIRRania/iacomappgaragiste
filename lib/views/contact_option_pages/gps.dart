...
class PlanAccesState extends State<PlanAcces>
  ...
  Widget _zoomminusfunction() {
    return Align(
      ...
      child: IconButton(
          icon: Icon(FontAwesomeIcons.searchMinus, color: Color(0xFF4267B2)),
          onPressed: () {
            zoomVal--;
            _minus(zoomVal);
          }),
  ...
  Future<void> _minus(double zoomVal) async {
    ...
    controller.animateCamera(CameraUpdate.newCameraPosition(CameraPosition(
        target: LatLng(46.701670698482715, 2.128639565478065), zoom: zoomVal)));
  }
